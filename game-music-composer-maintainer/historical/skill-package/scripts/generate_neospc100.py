...
OUT = Path('/mnt/data/neospc_work/output')
...
def main():
    ...
    report=audit(styles)
    catalog={'version':'3.0.0','project':'SNES MIDI Composer Expanded / Neo-SPC','voice_model':{'recommended':16,'profiles':[8,12,16,24,32],'benchmark_max':32,'hard_hardware_limit_removed':True},'categories':[{'id':c,'label':l,'count':10} for c,l in CATEGORY_DEFS],'styles':styles}

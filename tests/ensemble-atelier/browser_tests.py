...
with sync_playwright() as p:
 ...
 for id in ([os.environ['GMC_TEST_ID']] if os.environ.get('GMC_TEST_ID') else ['I001','I002','I003','I004','I005']):
  ...
  page.screenshot(path=str(OUT/(id+'-desktop.png')),full_page=True)
  ...
  page.screenshot(path=str(OUT/(id+'-mobile.png')),full_page=True)
  ...
  report['pages'][id]={'errors':errors,'requests':requests,'screenshot':'results/'+id+'-desktop.png'}

...
SRC=Path('/mnt/data/neospc_v4_work/data/neospc100-mixpass.json')
OUT=Path('/mnt/data/neospc_v4_work/data/neospc100-final.json')
MANIFEST=json.load(open('/mnt/data/neospc_v4_work/sample_bank/sample-bank.json'))
...
def main():
    ...
    d['version']='4.0.0';d['project']='Neo-SPC 100 / Full Rebuild + Professor Review + Performance Workstation'
    ...
    Path('/mnt/data/neospc_v4_work/reports/fast-detail-report-v4.json').write_text(json.dumps(report,indent=2))
